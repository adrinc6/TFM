...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{7.7cm}>{\raggedright\arraybackslash}p{7.7cm}@{}}
\caption{Defectos del desarrollo con impacto sobre la validez.}\label{tab:defectos}\\
\toprule
