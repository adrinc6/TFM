\begin{longtable}{@{}>{\raggedright\arraybackslash}p{3.9cm}>{\raggedright\arraybackslash}p{2.1cm}c>{\raggedright\arraybackslash}p{4.4cm}>{\raggedright\arraybackslash}p{2.2cm}@{}}
...
meta\_method & Meta-agente & Sí & equal, stacked rolling free, stacked rolling bounded & stacked rolling free \\
model\_family & Modelo & Sí & lightgbm, elastic net & lightgbm \\
snapshot\_step\_months & Temporal & Sí & 1, 3, 6, 12 & 1 \\
target\_size & Cartera informativa & No & 5, 8, 12, 16, 25, 50 & 8 \\
...
minimum\_holding\_period & Cartera informativa & No & none, quarter horizon, half horizon, full horizon & half horizon \\
coverage\_percentile\_floor & Cartera informativa & No & 0.0, 60.0, 80.0 & 60.0 \\
...
rebalance\_drift\_tolerance & Cartera informativa & No & 0.0, 0.1, 0.25, 0.4 & 0.25 \\
lgbm\_min\_child\_samples & Modelo & Sí & 20, 50, 100 & 20 \\
...
commission\_bps & Cartera informativa & No & 0.0, 5.0, 10.0 & 10.0 \\
feature\_weighting\_mode & Representación & Sí & model native, oos stability prune & oos stability prune \\
slippage\_bps & Cartera informativa & No & 5.0, 10.0, 20.0 & 20.0 \\
\end{longtable}
