...
A esas cuatro líneas hay que añadir una quinta que no es metodológica sino estructural, y que fija
el listón del segundo objetivo: la aritmética de la gestión activa de Sharpe (1991), según la cual el
conjunto de los gestores activos obtiene, antes de costes, exactamente el rendimiento del índice. La
Sección~\ref{sec:suma-cero-intro} la enuncia; aquí basta con señalar su consecuencia para la
literatura revisada. Un trabajo que reporta alfa persistente sobre un índice amplio está afirmando,
implícitamente, que ese alfa lo pagó otro participante, y el estándar de evidencia debe estar a la
altura de esa afirmación. Es la razón de fondo por la que la replicación (McLean y Pontiff, 2016;
Hou et al., 2020) encuentra tanta caída fuera de muestra: una anomalía publicada deja de ser una
ventaja informativa en el momento en que el resto del mercado puede explotarla.
