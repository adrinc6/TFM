...
abril de 2016: el primer año completo opera a ciegas, con la combinación ingenua.
...
no un detalle de implementación. La variante acotada obliga a que ningún agente pese menos
del 10\,\% ni más del 50\,\%: representa la idea de que una arquitectura de cinco especialistas sólo
tiene sentido si ninguno puede apagar a los demás. La variante libre no impone tope alguno,
...
El panel derecho responde a una pregunta distinta y más de fondo: por qué un modelo no lineal
