...
\section{Cómo se persiste y se audita la evidencia}

\subsection{Ciclo de vida de una ejecución}
...
\subsection{Cadena de custodia de la evidencia}

Cada nivel responde a una pregunta diferente y tiene un consumidor definido, según recoge la
Tabla~\ref{tab:cadena-custodia}:
