...
% impedía compilar el documento, y con doce referencias el coste de
% mantenerlas manualmente es menor que el de depurar el motor de citas.
% El fichero referencias.bib se conserva en el repositorio como registro
% de los datos bibliográficos completos (DOI, volumen, páginas).
%
