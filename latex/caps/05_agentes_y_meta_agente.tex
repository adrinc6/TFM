...
\textit{risk} obtiene 0,1229 y el meta 0,1004; en la segunda, 0,1199 y 0,0949. Ninguna es más
...
\begin{table}[H]
  ...
  \input{tablas/t05_rankic_era.tex}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.94\textwidth]{figuras/f05_rankic_era.png}
...
documenta en el Capítulo~\ref{chap:desarrollo}. Debe leerse junto a la advertencia estadística del
...
\begin{table}[H]
  ...
  \input{tablas/t05_meta_pesos_anual.tex}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.94\textwidth]{figuras/f05_pesos_anual.png}
...
sistema que decide con dos años de datos. En 2017 corrige hacia \textit{risk}, en 2018 lo lleva
hasta 0,493 y desde 2019 lo mantiene pegado al tope de 0,50 durante el resto de la serie.

\subsection*{Qué significa que el meta toque su propio tope}

Que el peso de \textit{risk} quede fijado en el límite superior durante ocho años consecutivos es un
resultado ambivalente y conviene no presentarlo sólo por su lado favorable.

Leído a favor, demuestra que el aprendizaje funciona: el sistema identifica a su mejor especialista
en unos dos años, partiendo de la ignorancia, y mantiene esa identificación de forma estable. La
rotación media de pesos, 0,0093, confirma que no se trata de oscilación mecánica.

Leído en contra, significa que la restricción de diseño es activa --- está mordiendo --- durante la
mayor parte de la ventana. El meta \emph{querría} asignar más peso a \textit{risk} y no puede. De
ahí que su Rank-IC quede por debajo del de \textit{risk} aislado: la diferencia entre 0,1004 y
0,1229 no mide un fallo de aprendizaje, mide el coste de una restricción impuesta a propósito.

La restricción se mantiene por una razón que no es de rendimiento. Un meta capaz de asignar el
100\,\% del peso a un único agente deja de ser un combinador y pasa a ser un selector, y su
comportamiento fuera de muestra depende por completo de que ese agente siga funcionando. La era
reservada ilustra ese riesgo: es precisamente donde los demás agentes se invierten. Un sistema con
todo el peso en \textit{risk} habría obtenido allí un Rank-IC mayor, pero la decisión de acotarlo se
tomó antes de observar esa era, que es cuando las decisiones de diseño tienen valor.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.94\textwidth]{figuras/f05_concentracion.png}
