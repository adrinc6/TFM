...
El sistema aprende una ordenación transversal fuera de muestra: su Rank-IC medio es 0,1090, supera
...
equiponderado porque aprende a reponderar especialistas a partir de cohortes cerradas, si bien el
agente de riesgo por separado ordena algo mejor que la combinación, lo que impide presentar la
arquitectura multi-agente como demostrada por estos datos.

El hallazgo central del trabajo, sin embargo, no está en el modelo sino en lo que ocurre al llevarlo
a una cartera. Con la construcción de cartera recomendada por el catálogo, la señal perdía un
11,29\,\% frente al índice en la era reservada, con Information Ratio $-1{,}167$ y ningún año por
encima. Con la cartera elegida por el estudio de optimización --- mismo modelo, misma señal, mismo
panel, sin reentrenar nada --- obtiene un exceso del 2,56\,\% con Information Ratio $+0{,}304$. El
Rank-IC de esa era es positivo en ambos casos, porque no depende de la cartera.
...
La respuesta económica es positiva pero mucho más acotada, y sólo es positiva con una precisión que
no puede omitirse: depende de la cartera. Con la cartera optimizada, el sistema supera a SPY en la
ventana de selección y también en la era reservada, neto de los costes modelados; con la cartera de
partida, no lo hacía en la era reservada. El Deflated Sharpe y el tamaño de la muestra efectiva
impiden transformar esa observación en una promesa de superioridad ajustada por riesgo. La
formulación defendible es que el ranking tiene evidencia predictiva robusta, que su implementación
puede ser económicamente compatible con esa señal bajo restricciones declaradas, y que la distancia
entre «puede serlo» y «lo es» la recorre la construcción de cartera y no el modelo.
...
\begin{enumerate}[leftmargin=*,itemsep=0.4em]
  ...
  decisión con una ventaja clara, pero es también la causa estructural de una rotación superior al
  300\,\%: re-decidir cada mes sobre una señal a doce meses. Separar la frecuencia de
  \emph{evaluación} de la de \emph{ejecución} permitiría conservar las 117 cohortes sin pagar la
  rotación asociada.
...
Algunas lecciones del desarrollo, documentadas en los Capítulos~\ref{chap:desarrollo-metodo}
y~\ref{chap:desarrollo-cartera}, son
