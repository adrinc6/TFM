...
La Tabla~\ref{tab:cadena} del Capítulo~\ref{chap:resultados} recoge el resultado de cada pasada: la
cadena mejoró de forma monótona en las cuatro métricas de selección. El Rank-IC pasó de 0,1000 a
0,1090, el IC-IR de 0,735 a 0,851, el coeficiente de transferencia de 0,178 a 0,328 y el Information
Ratio de 0,189 a 0,339.


Más informativo que la mejora es el patrón de convergencia. La
...
El detalle de qué variable cambió en cada pasada está en la Tabla~\ref{tab:cadena-config} del
