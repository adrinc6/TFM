...
larga apenas registra. Ambas opciones tienen, por tanto, un coste, y la elección entre reaccionar
antes o estimar con menos varianza no puede resolverse por intuición. El catálogo declara la
longitud de esa memoria con rejilla propia, aunque la pasada de referencia la ejecutó fijada en
dieciséis trimestres, de modo que su valor no procede de una comparación pareada: es una de las
cuatro variables predictivas que el Anexo~\ref{anexo:catalogo} identifica como fijadas de antemano.

\section{¿Es la señal una réplica de factores conocidos?}

Dos contrastes independientes preguntan lo mismo desde ángulos distintos, y ambos proceden de
\artefacto{attribution.json}.
...
--- va de $-0{,}01$\,\% a $+2{,}61$\,\% ---, hasta el punto de que \artefacto{robustness.json}
registra la estabilidad de la conclusión económica como \emph{falsa}. Conviene decirlo con esa
...
para que la diferencia sea visible; las cifras proceden de \artefacto{robustness.json}.
