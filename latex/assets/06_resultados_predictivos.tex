...
prácticamente degenerado --- 0,954 para \textit{risk} y 0,047 para \textit{value}, con los tres
...
74,36\% de cohortes positivas. Son 117 cohortes mensuales, aunque el horizonte de doce meses las
...
\texttt{garp\_score}, obtiene 0,0130; el sistema lo multiplica aproximadamente por ocho. No se infiere de ello que los factores clásicos sean inútiles,
...
después el Rank-IC, éste baja de 0,1177 a 0,1019. Conviene declarar de dónde sale ese 0,1177, porque
no coincide con el 0,1090 del resto del capítulo: el contraste se calcula sobre las mismas 117
...
sobre la misma muestra, de modo que su cociente sí es interpretable. La pérdida del 13,38\,\% indica
que parte de la señal comparte información con esos controles, como sería esperable en un sistema
que usa ratios económicos; la retención del \textbf{86,62\,\%} muestra que no se agota en ellos.

El segundo regresa los retornos contra cinco factores de estilo con errores Newey--West de doce
retardos (Newey y West, 1987). Sobre las 117 cohortes de selección el $R^2$ es 0,017 y ninguna carga
alcanza significación --- la mayor en valor absoluto es momentum, con $-0{,}105$ ---, de modo que no
hay exposición factorial estable. Su alfa por periodo, 0,27\,\% con $t=1{,}44$, tampoco es
...
económica no aguanta la misma prueba: el exceso geométrico \textbf{sí cruza cero} entre semillas
--- va de $-0{,}01$\,\% a $+2{,}61$\,\% ---, hasta el punto de que el propio estudio registra la
estabilidad de la conclusión económica como \emph{falsa}. Conviene decirlo con esa
crudeza: la misma configuración, cambiando sólo la inicialización del \textit{boosting}, puede no
batir al índice. La ordenación es estable; su traducción a rentabilidad, no. Esta asimetría es la
misma que motivó introducir el conjunto de semillas durante el desarrollo, según se documenta en el
...
riesgo emparejado, el modelo ocupa el percentil 96,8 (CAGR 15,56\,\% frente a una mediana aleatoria
del 9,23\,\%). En el escenario general baja al percentil 76,1, pero ese nulo no se usa como prueba
en ninguna dirección: su percentil 95 de CAGR llega al 75,06\,\%, dominado por carteras que por azar
