...
El capítulo anterior concluyó que la ordenación aprendida existe y resiste los contrastes que
...
Este capítulo responde a la segunda pregunta empírica, y conviene abrirlo con una advertencia
epistemológica que condiciona todo lo que sigue.
...
empleada como punto de partida y como referencia de contraste, y la que la rejilla eligió, que es
la que el documento adopta. No son intercambiables: producen resultados de signo opuesto en la era
reservada, y ése es precisamente el hallazgo del capítulo. Toda tabla y figura declara con cuál de
las dos se calculó, y las que proceden de la cartera del Model Study se marcan expresamente como
diagnósticas.
