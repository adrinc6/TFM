...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{\input{assets/t06_decisiones.tex}}
  ...
  que sólo ocurre en los empates técnicos. No debe confundirse con la \emph{ventaja pareada}, que
  promedia la diferencia cohorte a cohorte: en \artefacto{meta\_method} el coste es $-0{,}0071$ y la
  ventaja pareada $+0{,}00699$.}
\end{table}
...
media de tres diezmilésimas de Rank-IC. Entre las confirmadas, la comparación que midió mayor
diferencia fue \artefacto{meta\_method}, donde la variante libre obtuvo 0,1067 frente a 0,0996 de la
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{assets/f05_calibracion_alfa.png}
...
\begin{table}[H]
  ...
  \input{assets/t05_calibracion_estados.tex}
\end{table}
