...
nada, y reduciendo la rotación a la mitad. La mejora obtenida sin tocar el modelo es mayor que la
acumulada por las tres pasadas predictivas juntas.
...
Nada de esto es una promesa de inversión, y las razones son explícitas y ya están cuantificadas: el
Deflated Sharpe cae a 0,573, la era reservada aporta seis cohortes cerradas y algo más de un año de
cartera, y la cartera ganadora es la mejor de 1.440 evaluadas. Las tres apuntan en la misma
dirección --- el resultado descansa sobre menos evidencia independiente de la que aparenta --- y
ninguna se resuelve con más trabajo sobre los mismos datos. La contribución
...
real a lo conseguido y a lo no conseguido. La Sección~\ref{sec:suma-cero} lo desarrolla: batir a un
índice es un juego de suma negativa después de costes, y a veinte años la gran mayoría de los fondos
de gran capitalización no lo consigue. Sobre ese
...
recortada para que la ventana reservada siga siendo una comprobación y no un criterio. El balance
del Objetivo 2, al principio de este capítulo, es lo que justifica el esfuerzo.
...
\begin{enumerate}[leftmargin=*,itemsep=0.4em]
  ...
  decisión con una ventaja clara, pero es el origen del 71,5\,\% del flujo de órdenes: el sistema
  re-decide cada mes sobre una señal a doce meses. Separar la frecuencia de \emph{evaluación} de la
  de \emph{ejecución} permitiría conservar las 117 cohortes sin pagar esa parte de la rotación. Es
  además la única palanca que queda abierta por ese lado: la corrección de deriva de pesos, que
  aportaba la segunda partida de flujo, ya se relajó al máximo que el catálogo permite y con ello
  cayó a una sexta parte del total.
