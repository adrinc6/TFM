...
\begin{description}[leftmargin=0.5cm,style=nextline,font=\normalfont\ttfamily\small]
  ...
  \item[portfolio\_narrative.json, portfolio\_narrative\_holdings.parquet] Qué tuvo la cartera en
  cada momento: exposición sectorial, permanencia de las posiciones y detalle de las que más y menos
  contribuyeron. El manuscrito lo explota de forma agregada.
\end{description}
