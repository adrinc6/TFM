...
\path{coverage_percentile_floor} coincidieron con los de partida. La configuración adoptada
...
\begin{landscape}
\footnotesize
\input{assets/tB_diccionario_features.tex}
\end{landscape}
