...
Hay una tercera que la Sección~\ref{sec:relato-cartera} hace visible y ninguna métrica agregada
delata: el resultado económico se apoya en muy pocos nombres. De las 42 acciones que pasaron por la
cartera en diez años, la primera aporta 27,8 puntos de contribución neta y las cinco primeras la
mayor parte de lo acumulado; en la era reservada, donde la tenencia mínima impide casi toda
rotación, una sola posición aporta 21,3 de los puntos de la ventana. La consecuencia es que el
número de apuestas efectivamente independientes es bastante menor que los diez años de serie, y que
el resultado sería sensible a sustituir un puñado de posiciones por otras.

Hay una cuarta precisión, y es la que más condiciona las conclusiones: el orden predictivo y el
