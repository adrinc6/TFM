...
El estudio se ejecutó bajo la versión 5 del catálogo cerrado, mientras que el código actual está en
la versión 6: \textbf{una reejecución con el código actual no produciría los mismos resultados} y no
sería comparable con estudios de la versión 6. El razonamiento completo --- por qué se optó por
congelar el estudio en lugar de reejecutarlo, y qué queda garantizado pese a ello --- se documenta
en la Sección~\ref{sec:reproducibilidad}.
