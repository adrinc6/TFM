...
STAGE_FIELDS: dict[str, tuple[str, ...]] = {
    "agents_fit": (
        ...
        "feature_weighting_mode", "feature_selection_min_coverage",
        "feature_selection_lookback_quarters", "feature_selection_min_permutation_importance",
        "feature_selection_min_positive_fraction", "feature_selection_max_features_per_agent",
