...
- Study: `study-20260816-182345-3cc1a5fb`
- Ganador: `run-803c214fd2ac`
...
|---|---|---|
| Rank-IC medio | 0.1051 | `evidence/summary.json` |
| IC-IR | 0.8442 | `evidence/summary.json` |
...
| Métrica | Valor | Artefacto |
|---|---|---|
| Rank-IC medio | 0.0420 | `evidence/summary.json` |
...
| Métrica | Valor | Artefacto |
|---|---|---|
| CAGR cartera | 14.34 % | `evidence/summary.json` |
| CAGR benchmark | 13.17 % | `evidence/summary.json` |
| Alfa geométrico | 1.03 % | `evidence/summary.json` |
| Information Ratio anualizado | 0.1564 | `evidence/summary.json` |
| Turnover anualizado | 262.79 % | `evidence/summary.json` |
| Efectivo medio | 6.42 % | `evidence/summary.json` |
| Coeficiente de transferencia | 0.1302 | `evidence/summary.json` |
