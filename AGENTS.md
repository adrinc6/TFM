...
- SPY solo es benchmark y nunca una posición. Los umbrales de la cartera son económicos, en
  puntos básicos de alfa esperado. La política de efectivo (`fully_invested` u
  `opportunity_cash`, remunerado al 0 %) es una decisión de cartera, diagnóstica: no altera el
  Rank-IC y por tanto no puede elegir modelo.
