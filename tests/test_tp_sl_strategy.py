...
from module.steps.step_04_evaluation.strategy import compute_confidence, attach_confidence
from module.steps.step_04_evaluation.strategy import (
    compute_expected_value,
    select_portfolio,
    get_portfolio_weights,
)
from module.steps.step_04_evaluation.strategy import simulate_tp_sl, run_backtest
from module.steps.step_04_evaluation.strategy import AgentWeightTracker
...
class TestFullPipelineIntegration:
    ...
    def test_end_to_end(self, tmp_path):
        from module.steps.step_04_evaluation.strategy import attach_confidence
        from module.steps.step_04_evaluation.strategy import select_portfolio
        from module.steps.step_04_evaluation.strategy import run_backtest
        from module.steps.step_04_evaluation.reporting import export_strategy_csv
